...
//            $stopLnFiltersInTitle = true;
//        }
        $this->_updateTitle($this->_getTitle($block), $stopLnFiltersInTitle);
...
//            $stopLnFiltersInMetaDescription = true;
//        }
        $this->_updateMetaDescription($block->getDescription(), $stopLnFiltersInMetaDescription);
...
//        if ($this->_callXTemplatesMetaKeywordsRenderer($block)) {
//            $stopLnFiltersInMetaKeywords = true;
//        }
        $this->_updateMetaKeywords($block->getKeywords(), $stopLnFiltersInMetaKeywords);
