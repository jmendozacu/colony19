...
class SDW_Provider_Block_Adminhtml_Listing_Render_Alerte extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
		...
		if($necessaire > 0)	return '<span style="color:red;">A</span>';
		else return ;
    }
}