   ...
   protected function _prepareCollection()
   {
	...
	{	
		...
		$this->addColumn('name', array(
			...
			'filter'    => false,
			'sortable'  => false,
			'renderer'  => 'SDW_Provider_Block_Adminhtml_Listing_Render_Name',
        ));
		...
		$this->addColumn('sku', array(
			...
			'filter'    => false,
			'sortable'  => false,
			'renderer'  => 'SDW_Provider_Block_Adminhtml_Listing_Render_Sku',
        ));
		...
		$this->addColumn('qty', array(
			...
			'filter'    => false,
			'sortable'  => false,
			'renderer'  => 'SDW_Provider_Block_Adminhtml_Listing_Render_Quantite',
		));
        ...
        $this->addColumn('order_estimate', array(
			...
			'filter'    => false,
			'sortable'  => false,
			'renderer'  => 'SDW_Provider_Block_Adminhtml_Listing_Render_Livraison',
        ));
