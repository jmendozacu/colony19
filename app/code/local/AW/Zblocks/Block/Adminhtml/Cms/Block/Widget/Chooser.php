...
class AW_Zblocks_Block_Adminhtml_Cms_Block_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('adminhtml/zblocks_block_widget/chooser', array('uniq_id' => $uniqId));
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
                ...
                ->where('block_position = ?', AW_Zblocks_Model_Source_Position::WIDGET_POSITION)
    ...
    {
        return $this->getUrl('adminhtml/zblocks_block_widget/chooser', array('_current' => true));
    }
