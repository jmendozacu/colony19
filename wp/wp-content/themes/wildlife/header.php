...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo CHILD_URL; ?>/chris.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo CHILD_URL; ?>/colony.css" />
...
<!--
	<div id="motopress-main" class="main-holder border">
